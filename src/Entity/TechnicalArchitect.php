...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TechnicalArchitectRepository")
 */
class TechnicalArchitect
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Remodeling", mappedBy="technicalArchitect")
     *
     */
    private $remodelings;
    ...
    public function addRemodeling(Remodeling $remodeling): self
    {
        if (!$this->remodelings->contains($remodeling)) {
            ...
            $remodeling->setTechnicalArchitect($this);
        }
